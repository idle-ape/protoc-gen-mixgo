...
const (
	HelloWorld_Greet_FullMethodName = "/example.HelloWorld/Greet"
)
...
func (c *helloWorldClient) Greet(ctx context.Context, in *HelloReq, opts ...grpc.CallOption) (*HelloResp, error) {
	out := new(HelloResp)
...
func (UnimplementedHelloWorldServer) Greet(context.Context, *HelloReq) (*HelloResp, error) {
...
func _HelloWorld_Greet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloWorldServer).Greet(ctx, req.(*HelloReq))
	}
